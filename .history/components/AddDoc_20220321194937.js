    ...
    >
      <Box sx={style}>
        ...
        <div className="mt-10 flex space-x-4 ">
          <Button
            sx={{ mx: 6 }}
            className="text-gray-800 bg-gray-300 capitalize hover:bg-gray-400 "
            onClick={handleClose}
          >
            Cancel{" "}
          </Button>
          <button
            sx={{ mt: 6 }}
            className="bg-yellow-500 capitalize hover:bg-yellow-400 text-sm rounded-2xl text-white p-5 "
